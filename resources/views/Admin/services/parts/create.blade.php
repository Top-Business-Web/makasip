<form id="addForm" class="addForm" method="POST" enctype="multipart/form-data" action="{{route('services.store')}}">
    ...
    <input type="hidden" value="" id="iconInput" name="icon">
    </div>
    <div class="row">
        <div class="col-6">
            <div class="form-group">
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <textarea rows="3" class="form-control" name="desc_ar" placeholder="شرح ووصف ما يتم توفيره في الخدمة باللغة العربية"></textarea>
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
                <label for="desc_en" class="form-control-label">وصف الخدمة (en)</label>
                <textarea rows="3" class="form-control" name="desc_en" placeholder="شرح ووصف ما يتم توفيره في الخدمة باللغة الانجليزية"></textarea>
            </div>
        </div>
    </div>
