...
@section('title')
     | نقطة الاعدادات
@endsection
@section('page_name') نقطة الاعدادات @endsection
@section('content')
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">نقطة الاعدادات</h3>
                </div>
                <div class="card-body">
...
@section('ajaxCalls')
    <script>
        ...
        showData('{{route('settingPoints.index')}}', columns);

        // Add Using Ajax
        showEditModal('{{route('settingPoints.edit',':id')}}');
        editScript();
    </script>
@endsection
