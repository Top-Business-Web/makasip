...
{{--                            تعديل الرصيد--}}
{{--                        </button>--}}
{{--                        <button type="button" class="btn btn-warning" id="edit_btn">تعديل !</button>--}}
{{--                    </div>--}}
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" id="dismiss_delete_modal">
                            الغاء
        ...
        <div class="modal fade bd-example-modal-sm" id="editOrCreate" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">تعديل الرصيد</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
@section('ajaxCalls')
    <script>
        ...
        destroyScript('{{route('usersDelete')}}');
