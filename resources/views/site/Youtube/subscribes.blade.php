    ...
    <div class="MainPage d-flex">
        ...
        <div class="Home Followers">
                ...
                <div class="row  align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="shareBox">
                            ...
                            <div>
                                <button class="mainButton Youtubes"><a href="{{route('AddSite', $type)}}">
            ...
            <div class="container">
                ...
                @if($data->count())
                    <div class="table Youtube" style="overflow-y: auto;">
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <button data-site-id={{$row->id}} data-url="{{$row->url}}"
                                                        class="Deletes Youtubes customBtn StartBtn mb-2">
                                                    {{trans('site.start')}}
                                                </button>
                                                <button data-site-id={{$row->id}} data-url="{{$row->url}}" data-user-id={{ auth()->user()->id }}
                                                        class="Deletes d-none Youtubes customBtn myShareBtn">{{trans('site.subscriber')}}
                                                </button>
