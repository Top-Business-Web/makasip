    ...
    <div class="MainPage d-flex">
        ...
        <div class="Home Followers">
                ...
                <div class="row  align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="shareBox">
                            ...
                            <div>
                                <button class="mainButton TikTokss"><a href="{{route('AddSite', $type)}}">
            ...
            <div class="container">
                ...
                @if($data->count())
                    <div class="table TikToks" style="overflow-y: auto;">
                                        ...
                                        <td>
                                            <div class="text-center">
                                                <button data-site-id={{$row->id}} data-url="{{$row->url}}"
                                                        class="Deletes TikTokss customBtn StartBtn">
                                                    {{trans('site.start')}}
                                                </button>
                                                <button data-site-id={{$row->id}} data-url="{{$row->url}}" data-user-id={{ auth()->user()->id }}
                                                        class="Deletes d-none TikTokss customBtn myShareBtn">{{trans('site.done')}}
                                                </button>
