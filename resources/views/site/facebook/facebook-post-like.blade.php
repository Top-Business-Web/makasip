...
@section('content')
    ...
    <div class="MainPage d-flex">
        ...
        <div class="Home POstLike ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="shareBox">
                            ...
                            <h3 class="fs-5 fw-bold">
                                {{ trans('site.For this section only - click the FOLLOW button if there is no LIKE button in the pop-up windowA') }}
                            </h3>
            ...
            @if ($data->count() > 0)
                <div class="container">
                    <h3 class="fs-4 fw-bold TitlePage">
                        {{ trans('site.Wait 9-10 seconds') }}
                    </h3>
                    @if ($data->count() > 0)
                        <div class="table">
